                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h1>Card </h1>
                            <a href="{{ route('cardType.create') }}" class="btn btn-light">Create </a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                @forelse ($cardTypeData as $cardType)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('cardType.duplicate', $cardType->id) }}" class="btn btn-warning">Duplicate</a>
